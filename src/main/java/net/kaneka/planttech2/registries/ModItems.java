...
public class ModItems
{
	...
	public static UpgradeChipItem CAPACITYCHIP_TIER_1 = new UpgradeChipItem("capacitychip_tier_1").setIncreaseCapacity(2000).setEnergyCost(10), 
				...
				REAKTORCHIP_TIER_1 = new UpgradeChipItem("reaktorchip_tier_1").setEnergyProduction(1).setEnergyCost(10), 
				REAKTORCHIP_TIER_2 = new UpgradeChipItem("reaktorchip_tier_2").setEnergyProduction(3).setEnergyCost(20), 
				REAKTORCHIP_TIER_3 = new UpgradeChipItem("reaktorchip_tier_3").setEnergyProduction(5).setEnergyCost(50), 
