...
public class ModBlocks
{
	...
	public static BlockBase 
	        ...
	        INFUSER = new BlockMachineFacing("infuser", PlantTechMain.groupmachines),
		    ...
		    MACHINESHELL = new BlockBase(Block.Properties.create(Material.IRON), "machineshell", PlantTechMain.groupmain, true),  
		    MACHINESHELL_INFUSED = new BlockBase(Block.Properties.create(Material.IRON), "machineshell_infused", PlantTechMain.groupmain, true),  
