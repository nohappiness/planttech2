...
public class PlantTopiaChunkGenerator extends NoiseChunkGenerator<PlantTopiaGenSettings>
{
	...
	public PlantTopiaChunkGenerator(IWorld world)
	{
		super(world, new PlantTopiaBiomeProvider(world.getSeed()), 4, 8, 256, new PlantTopiaGenSettings(world.getSeed()), true);
