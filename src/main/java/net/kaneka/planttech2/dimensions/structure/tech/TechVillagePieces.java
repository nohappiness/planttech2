...
public class TechVillagePieces
{
	...
	{
		JigsawManager.addPieces(new ResourceLocation(ModReferences.MODID,"village/tech/starts"), 7, TechVillagePieces.TechVillage::new, chunkGenerator, templateManager, pos, piecesList, seed);
	}
	...
	static {
		...
		JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(ModReferences.MODID,"village/tech/houses"), new ResourceLocation("empty"), ImmutableList.of(Pair.of(new SingleJigsawPiece(ModReferences.MODID + ":village/tech/houses/techhouse1"), 1)), JigsawPattern.PlacementBehaviour.RIGID));
