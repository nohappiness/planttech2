...
public class CropList
{
    ...
    {
	return nextID - amountBlacklisted;
    }
	...
	// addEntry("", PlanttechMain.modId + ":plants/plant_", PlanttechMain.modId + ":textures/blocks/plants/plant_.png", Integer.parseInt("",16));
	...
	this.getEntryByName("dandelion").addSeeds(new ItemStack(Blocks.DANDELION)).addDrop(new ItemStack(ModItems.COLOR_PARTICLES), 1, 4).addDrop(new ItemStack(Blocks.DANDELION), 0, 4);
	...
	this.getEntryByName("mushroom").addSeeds(new ItemStack(Blocks.RED_MUSHROOM), new ItemStack(Blocks.BROWN_MUSHROOM)).addDrop(new ItemStack(Blocks.RED_MUSHROOM), 0, 4).addDrop(new ItemStack(Blocks.BROWN_MUSHROOM), 0, 4);
	this.getEntryByName("mycelium");
	this.getEntryByName("netherrack");
	this.getEntryByName("nether_wart");
	this.getEntryByName("orange_tulip").addSeeds(new ItemStack(Blocks.ORANGE_TULIP)).addDrop(new ItemStack(ModItems.COLOR_PARTICLES), 1, 4).addDrop(new ItemStack(Blocks.ORANGE_TULIP), 0, 4);
	this.getEntryByName("oxeye_daisy").addSeeds(new ItemStack(Blocks.OXEYE_DAISY)).addDrop(new ItemStack(ModItems.COLOR_PARTICLES), 1, 4).addDrop(new ItemStack(Blocks.OXEYE_DAISY), 0, 4);
	this.getEntryByName("panda");
	this.getEntryByName("parrot");
	this.getEntryByName("pig");
	this.getEntryByName("pink_tulip").addSeeds(new ItemStack(Blocks.PINK_TULIP)).addDrop(new ItemStack(ModItems.COLOR_PARTICLES), 1, 4).addDrop(new ItemStack(Blocks.PINK_TULIP), 0, 4);
	...
	this.getEntryByName("red_tulip").addSeeds(new ItemStack(Blocks.RED_TULIP)).addDrop(new ItemStack(ModItems.COLOR_PARTICLES), 1, 4).addDrop(new ItemStack(Blocks.RED_TULIP), 0, 4);
	...
	this.getEntryByName("white_tulip").addSeeds(new ItemStack(Blocks.WHITE_TULIP)).addDrop(new ItemStack(ModItems.COLOR_PARTICLES), 1, 4).addDrop(new ItemStack(Blocks.WHITE_TULIP), 0, 4);
	...
	for (String input : list)
	{
		...
		if (input.charAt(0) != '/')
		{
			...
			{
			    if (existEntry(splitted[0], i) && existEntry(splitted[1], i) && existEntry(splitted[2], i))
			    {
				this.getEntryByName(splitted[0]).addParents(splitted[1], splitted[2], Float.valueOf(splitted[3]));
			    }
			    else
			    {
	...
	for (String input : list)
	{
		...
		if (input.charAt(0) != '/')
		{
			...
			if (splitted.length == 3)
			{
			    ...
			    if (existEntry(splitted[0], i))
			    {
				this.getEntryByName(splitted[0]).setSoil(new ItemStack(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(splitted[1]))));
			    }
			    else
			    {
				PlantTechMain.LOGGER.info("line " + i + " not existing croptype: " + input);
