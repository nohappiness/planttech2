...
{ 
	...
	public GUIDNARemover(InventoryPlayer player, TileEntityDNARemover te) 
	{
		super(new ContainerDNARemover(player, te), te, player);
	...
	private int getCookProgressScaled(int pixels)
	{
		...
		return i != 0 ? i * pixels / ((TileEntityDNARemover) this.te).ticksPerItem() : 0;
	}
}
