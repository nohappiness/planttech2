...
{ 
	...
	public GUIDNACombiner(InventoryPlayer player, TileEntityDNACombiner te) 
	{
		super(new ContainerDNACombiner(player, te), te, player);
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		this.drawTexturedModalRect(this.guiLeft + 98, this.guiTop + 38, 0, 202, 20, l);
