...
{
	public MachineBulbReprocessorContainer(int id, Inventory inv)
	{
		this(id, inv, new MachineBulbReprocessorBlockEntity());
	}
	
	public MachineBulbReprocessorContainer(int id, Inventory player, MachineBulbReprocessorBlockEntity tileentity)
	{
