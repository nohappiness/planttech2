package net.kaneka.planttech2.inventory.entities;
...
public class TechVillagerContainer extends Container
{
	...
	public TechVillagerContainer(int id, Inventory inv,ByteBuf data)
	{
	...
	public TechVillagerContainer(int id, Inventory playerInv, List<TechVillagerTrade> trades, int profession)
	{ 
