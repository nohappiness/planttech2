...
public class ChunkGeneratorPlantTopia extends NoiseChunkGenerator<PlantTopiaGenSettings> {
	...
	public ChunkGeneratorPlantTopia(IWorld worldIn, BiomeProvider provider, PlantTopiaGenSettings settingsIn) {
