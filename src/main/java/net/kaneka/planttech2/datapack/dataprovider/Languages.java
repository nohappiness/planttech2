...
public class Languages extends LanguageProvider
{
    ...
    private void addMisc()
    {
        ...
        add("temp.EXTREME_COLD", "extreme cold");
        add("temp.COLD", "cold");
        add("temp.NORMAL", "normal");
        add("temp.WARM", "warm");
        add("temp.EXTREME_WARM", "extreme warm");
    }
    ...
    public void addCrops()
    {
        ...
        langKeys.putIfAbsent("item." + MODID + ".beast_seeds", "Ravager Seeds");
        langKeys.putIfAbsent("item." + MODID + ".beast_particles", "Ravager Particles");
        // TODO: change prismarin -> prismarine
        ...
        {
            String name = entry.getString().intern();
