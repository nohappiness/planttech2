...
//        add(ModEffects.RADIATION_SICKNESS, "Radiation Sickness");
    ...
    {
        add(GUIDE_OVERVIEW, "Tablet: PlantTech 2 Guide");
        add(GUIDE_PLANTS, "Tablet: Plant Encyclopedia");
        add(GUIDE_GENETIC_ENGINEERING, "Tablet: Genetic Engineering (NO FUNKTION!)");
        add(ANALYSER, "Analyzer");
        add(ADVANCED_ANALYSER, "Advanced Analyzer");
        add(CROPREMOVER, "Crop Remover");
        add(WRENCH, "Wrench");
        add(THERMOMETER, "Thermometer");
        add(SOLARFOCUS_TIER_1, "Class 1 Solar Focus");
        add(SOLARFOCUS_TIER_2, "Class 2 Solar Focus");
        add(SOLARFOCUS_TIER_3, "Class 3 Solar Focus");
        add(SOLARFOCUS_TIER_4, "Class 4 Solar Focus");
        add(SPEEDUPGRADE_TIER_1, "Speed Upgrade v1.0");
        add(SPEEDUPGRADE_TIER_2, "Speed Upgrade v2.0");
        add(SPEEDUPGRADE_TIER_3, "Speed Upgrade v3.0");
        add(SPEEDUPGRADE_TIER_4, "Speed Upgrade v4.0");
        add(RANGEUPGRADE_TIER_1, "Range Upgrade v1.0");
        add(RANGEUPGRADE_TIER_2, "Range Upgrade v2.0");
        add(RANGEUPGRADE_TIER_3, "Range Upgrade v3.0");
        add(RANGEUPGRADE_TIER_4, "Range Upgrade v4.0");
        add(CAPACITYUPGRADE_TIER_1, "Capacity Upgrade v1.0");
        add(CAPACITYUPGRADE_TIER_2, "Capacity Upgrade v2.0");
        add(CAPACITYUPGRADE_TIER_3, "Capacity Upgrade v3.0");
        add(PLANTIUM_INGOT, "Plantium Ingot");
        add(PLANTIUM_NUGGET, "Plantium Nugget");
        add(DANCIUM_INGOT, "Dancium Ingot");
        add(DANCIUM_NUGGET, "Dancium Nugget");
        add(KANEKIUM_INGOT, "Kanekium Ingot");
        add(KANEKIUM_NUGGET, "Kanekium Nugget");
        add(KINNOIUM_INGOT, "Kinnoium Ingot");
        add(KINNOIUM_NUGGET, "Kinnoium Nugget");
        add(LENTHURIUM_INGOT, "Lenthurium Ingot");
        add(LENTHURIUM_NUGGET, "Lenthurium Nugget");
        add(BIOMASS, "Biomass");
        add(DNA_CONTAINER_EMPTY, "Empty DNA Container");
        add(DNA_CONTAINER, "DNA Container");
        add(FERTILIZER_TIER_1, "G1 Fertilizer");
        add(FERTILIZER_TIER_2, "G2 Fertilizer");
        add(FERTILIZER_TIER_3, "G3 Fertilizer");
        add(FERTILIZER_TIER_4, "G4 Fertilizer");
        add(FERTILIZER_CREATIVE, "Creative Fertilizer");
        add(GEAR_KANEKIUM, "Kanekium Gear");
        add(GEAR_LENTHURIUM, "Lenthurium Gear");
        add(GEAR_KINNOIUM, "Kinnoium Gear");
        add(GEAR_DANCIUM, "Dancium Gear");
        add(GEAR_IRON, "Iron Gear");
        add(GEAR_PLANTIUM, "Plantium Gear");
        add(GEAR_KANEKIUM_INFUSED, "Infused Kanekium Gear");
        add(GEAR_LENTHURIUM_INFUSED, "Infused Lenthurium Gear");
        add(GEAR_KINNOIUM_INFUSED, "Infused Kinnoium Gear");
        add(GEAR_DANCIUM_INFUSED, "Infused Dancium Gear");
        add(GEAR_IRON_INFUSED, "Infused Iron Gear");
        add(GEAR_PLANTIUM_INFUSED, "Infused Plantium Gear");
        add(REDSTONE_INFUSED, "Infused Redstone");
        add(BIOMASSCONTAINER, "Biomasscontainer");
        add(ENERGYSTORAGE_TIER_1, "Class 1 Battery");
        add(ENERGYSTORAGE_TIER_2, "Class 2 Battery");
        add(ENERGYSTORAGE_TIER_3, "Class 3 Battery");
        add(KNOWLEDGECHIP_TIER_0, "Knowledge Chip v0a");
        add(KNOWLEDGECHIP_TIER_1, "Knowledge Chip v1.0");
        add(KNOWLEDGECHIP_TIER_2, "Knowledge Chip v2.0");
        add(KNOWLEDGECHIP_TIER_3, "Knowledge Chip v3.0");
        add(KNOWLEDGECHIP_TIER_4, "Knowledge Chip v4.0");
        add(KNOWLEDGECHIP_TIER_5, "Knowledge Chip v5.0");
        add(WHITE_CRYSTAL, "White Crystal");
        add(DARK_CRYSTAL, "Dark Crystal");

        add(PLANT_OBTAINER, "Plant Obtainer");
        add(RADIATION_METRE, "Radiation Metre");

        add(BIOMASS_BUCKET, "Biomass Bucket");
        add(MACHINEBULBREPROCESSOR_BULB, "Machinebulb Reprocessor Bulb");
        add(DNA_COMBINER_BULB, "DNA Combiner Bulb");
        add(DNA_EXTRACTOR_BULB, "DNA Extractor Bulb");
        add(DNA_REMOVER_BULB, "DNA Remover Bulb");
        add(DNA_CLEANER_BULB, "DNA Cleaner Bulb");
        add(CHIPALYZER_BULB, "Chipalyzer Bulb");
        add(COMPRESSOR_BULB, "Compressor Bulb");
        add(IDENTIFIER_BULB, "Identifier Bulb");
        add(INFUSER_BULB, "Infuser Bulb");
        add(SEEDSQUEEZER_BULB, "Seed Squeezer Bulb");
        add(SOLARGENERATOR_BULB, "Solar Generator Bulb");
        add(MEGAFURNACE_BULB, "Megafurnace Bulb");
        add(PLANTFARM_BULB, "Plantfarm Bulb");
        add(SEEDCONSTRUCTOR_BULB, "Seed Constructor Bulb");
        add(ENERGY_SUPPLIER_BULB, "Energy Supplier Bulb");

        add(CYBERBOW, "CyberBow");
        add(CYBERDAGGER, "CyberDagger");
        add(CYBERKATANA, "CyberKatana");
        add(CYBERRAPIER, "CyberRapier");
        add(MULTITOOL, "MultiTool");

        add(CYBERARMOR_HELMET, "CyberArmor Helmet");
        add(CYBERARMOR_CHEST, "CyberArmor Chest");
        add(CYBERARMOR_LEGGINGS, "CyberArmor Leggings");
        add(CYBERARMOR_BOOTS, "CyberArmor Boots");

        add(EMPTY_UPGRADECHIP_TIER_1, "Blank Upgrade Chip");
        add(EMPTY_UPGRADECHIP_TIER_2, "v2.0 Chip Upgrade Pack");
        add(EMPTY_UPGRADECHIP_TIER_3, "v3.0 Chip Upgrade Pack");
        add(CHIP_UPGRADEPACK_CAPACITY_1, "v2.0 Capacity Chip Upgrade Pack");
        add(CHIP_UPGRADEPACK_CAPACITY_2, "v3.0 Capacity Chip Upgrade Pack");
        add(CHIP_UPGRADEPACK_HARVESTLEVEL_1, "v2.0 Harvest Level Chip Upgrade Pack");
        add(CHIP_UPGRADEPACK_HARVESTLEVEL_2, "v3.0 Harvest Level Chip Upgrade Pack");
        add(CHIP_UPGRADEPACK_REACTOR_1, "v2.0 Reactor Chip Upgrade Pack");
        add(CHIP_UPGRADEPACK_REACTOR_2, "v3.0 Reactor Chip Upgrade Pack");

        add(CAPACITYCHIP_TIER_1, "Capacity Chip v1.0");
        add(CAPACITYCHIP_TIER_2, "Capacity Chip v2.0");
        add(CAPACITYCHIP_TIER_3, "Capacity Chip v3.0");
        add(HARVESTLEVELCHIP_TIER_1, "Harvest Level Chip v1.0");
        add(HARVESTLEVELCHIP_TIER_2, "Harvest Level Chip v2.0");
        add(HARVESTLEVELCHIP_TIER_3, "Harvest Level Chip v3.0");
        add(ATTACKCHIP_TIER_1, "Attack Chip v1.0");
        add(ATTACKCHIP_TIER_2, "Attack Chip v2.0");
        add(ATTACKCHIP_TIER_3, "Attack Chip v3.0");
        add(BREAKDOWNRATECHIP_TIER_1, "Breakdown Rate Chip v1.0");
        add(BREAKDOWNRATECHIP_TIER_2, "Breakdown Rate Chip v2.0");
        add(BREAKDOWNRATECHIP_TIER_3, "Breakdown Rate Chip v3.0");
        add(ARMORCHIP_TIER_1, "Armor Chip v1.0");
        add(ARMORCHIP_TIER_2, "Armor Chip v2.0");
        add(ARMORCHIP_TIER_3, "Armor Chip v3.0");
        add(TOUGHNESSCHIP_TIER_1, "Toughness Chip v1.0");
        add(TOUGHNESSCHIP_TIER_2, "Toughness Chip v2.0");
        add(TOUGHNESSCHIP_TIER_3, "Toughness Chip v3.0");
        add(ATTACKSPEEDCHIP_TIER_1, "Attack Speed Chip v1.0");
        add(ATTACKSPEEDCHIP_TIER_2, "Attack Speed Chip v2.0");
        add(ATTACKSPEEDCHIP_TIER_3, "Attack Speed Chip v3.0");
        add(REACTORCHIP_TIER_1, "Reactor Chip v1.0");
        add(REACTORCHIP_TIER_2, "Reactor Chip v2.0");
        add(REACTORCHIP_TIER_3, "Reactor Chip v3.0");
        add(UNLOCKCHIP_SHOVEL, "Unlock Chip: Shovel");
        add(UNLOCKCHIP_AXE, "Unlock Chip: Axe");
        add(UNLOCKCHIP_SHEARS, "Unlock Chip: Shears");
        add(UNLOCKCHIP_HOE, "Unlock Chip: Hoe");

        add(PROTECTION_CHIP, "Protection Chip");
        add(FIRE_PROTECTION_CHIP, "Fire Protection Chip");
        add(FEATHER_FALLING_CHIP, "Feather Falling Chip");
        add(BLAST_PROTECTION_CHIP, "Blast Protection Chip");
        add(PROJECTILE_PROTECTION_CHIP, "Projectile Protection Chip");
        add(RESPIRATION_CHIP, "Respiration Chip");
        add(AQUA_AFFINITY_CHIP, "Aqua Affinity Chip");
        add(THORNS_CHIP, "Thorns Chip");
        add(DEPTH_STRIDER_CHIP, "Depth Strider Chip");
        add(FROST_WALKER_CHIP, "Frost Walker Chip");
        add(SHARPNESS_CHIP, "Sharpness Chip");
        add(SMITE_CHIP, "Smite Chip");
        add(BANE_OF_ARTHROPODS_CHIP, "Bane of Arthropods Chip");
        add(KNOCKBACK_CHIP, "Knockback Chip");
        add(FIRE_ASPECT_CHIP, "Fire Aspect Chip");
        add(LOOTING_CHIP, "Looting Chip");
        add(SWEEPING_CHIP, "Sweeping Chip");
        add(EFFICIENCY_CHIP, "Efficiency Chip");
        add(SILK_TOUCH_CHIP, "Silk Touch Chip");
        add(UNBREAKING_CHIP, "Unbreaking Chip");
        add(FORTUNE_CHIP, "Fortune Chip");
        add(POWER_CHIP, "Power Chip");
        add(PUNCH_CHIP, "Punch Chip");
        add(FLAME_CHIP, "Flame Chip");
        add(INFINITY_CHIP, "Infinity Chip");

        add(AURA_CORE_LIGHT_DECREASE_I, "Aura Core - Light Level I");
        add(AURA_CORE_LIGHT_DECREASE_II, "Aura Core - Light Level II");
        add(AURA_CORE_LIGHT_DECREASE_III, "Aura Core - Light Level III");
        add(AURA_CORE_WATER_RANGE_DECREASE_I, "Aura Core - Water Range I");
        add(AURA_CORE_WATER_RANGE_DECREASE_II, "Aura Core - Water Range II");
        add(AURA_CORE_WATER_RANGE_DECREASE_III, "Aura Core - Water Range III");
        add(AURA_CORE_TEMPERATURE_EXTREME_COLD, "Aura Core - Temperature Extreme Cold");
        add(AURA_CORE_TEMPERATURE_COLD, "Aura Core - Temperature Cold");
        add(AURA_CORE_TEMPERATURE_NORMAL, "Aura Core - Temperature Normal");
        add(AURA_CORE_TEMPERATURE_WARM, "Aura Core - Temperature Warm");
        add(AURA_CORE_TEMPERATURE_EXTREME_WARM, "Aura Core - Temperature Extreme Warm");
        add(AURA_CORE_FERTILITY_INCREASE_I, "Aura Core - Fertility I");
        add(AURA_CORE_FERTILITY_INCREASE_II, "Aura Core - Fertility II");
        add(AURA_CORE_FERTILITY_INCREASE_III, "Aura Core - Fertility III");
        add(AURA_CORE_PRODUCTIVITY_INCREASE_I, "Aura Core - Productivity I");
        add(AURA_CORE_PRODUCTIVITY_INCREASE_II, "Aura Core - Productivity II");
        add(AURA_CORE_PRODUCTIVITY_INCREASE_III, "Aura Core - Productivity III");
    ...
    {
        add(COLOR_PARTICLES, "Color Particles");
