...
{
	public ContainerInfuser(int id, PlayerInventory inv)
	{
		this(id, inv, new TileEntityInfuser()); 
	}
	
	public ContainerInfuser(int id, PlayerInventory player, TileEntityInfuser tileentity) 
	{
		super(id, ModContainers.INFUSER, player, tileentity, 5);
