...
public class ContainerDNACombiner extends ContainerBase
{
	
	public ContainerDNACombiner(int id, PlayerInventory inv)
	{
		this(id, inv, new TileEntityDNACombiner()); 
	}
	
	public ContainerDNACombiner(int id, PlayerInventory player, TileEntityDNACombiner tileentity) 
	{
