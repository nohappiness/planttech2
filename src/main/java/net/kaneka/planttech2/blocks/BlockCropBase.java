...
public class BlockCropBase extends BlockContainer
{
    ...
    {
	for (BlockPos.MutableBlockPos blockpos$mutableblockpos : BlockPos.getAllInBoxMutable(pos.add(((-1) * (waterSensitivity + 1)), 0, ((-1) * (waterSensitivity + 1))), pos.add((waterSensitivity + 1), -1, (waterSensitivity + 1))))
	{
